...
@NgModule({
  declarations: [GalleryComponent, PhotoPieceComponent],
  imports: [GalleryRoutingModule, TranslateModule, CommonModule],
  exports: [GalleryComponent, GalleryRoutingModule, PhotoPieceComponent],
})
